...
def load_data_s3dis(partition):
    ##### This is important, get the directories, txts right#############
    s3dis_download()
    BASE_DIR = os.path.dirname(os.path.abspath("__file__"))
    DATA_DIR = os.path.join(BASE_DIR, 'data')
    points = []
    ...
    indices_split_to_full = []
    if partition == 'train':
        filelist="C:\\Users\\mthossain\\OneDrive - Federation University Australia\\Desktop\\soft study\\Euclideon\\0 Code Base\\NMadali_PointCNN\\train_files.txt"
    else:
        filelist="C:\\Users\\mthossain\\OneDrive - Federation University Australia\\Desktop\\soft study\\Euclideon\\0 Code Base\\NMadali_PointCNN\\train_files.txt"
